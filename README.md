...
## 🚀 Selected Projects
- EcoVision — UAV-based plant species identification & dominance analysis system
...
- Highlights / Metrics:
  Semantic segmentation + blob extraction + species classification pipeline
  ~95% classification accuracy on trained species
  Automated 2×2m patch-based dominance scoring for ecological surveys
  Designed for research publication and field deployment
- Link: (Private / available on request)

- CallsAid — AI-powered voice & workflow automation platform for businesses
...
- Highlights / Metrics:
  Voice AI agents integrated with business workflows
  Role-based access (Business Owner / Department Manager)
  Built for multilingual expansion (Africa-first design)
